...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GoldMind AI — Institutional-grade XAUUSD Intelligence" },
      { name: "description", content: "AI-powered gold trading assistant. Real-time XAUUSD analysis using Smart Money Concepts, transparent reasoning, paper trading, and risk-managed setups." },
      { name: "author", content: "GoldMind AI" },
      { property: "og:title", content: "GoldMind AI — XAUUSD Trading Intelligence" },
      { property: "og:description", content: "Real-time gold market analysis, high-probability ICT setups, explained decisions, and paper execution." },
